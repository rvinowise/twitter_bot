...
type Attention_in_matrix = {
    absolute_attention: Map<User_handle, Map<User_handle, int>> //uncludes only members of the matrix as attentors and targets
    total_known_attention: Map<User_handle, int> //including attention paid to people outside of this matrix
    relative_attention: Map<User_handle, Map<User_handle, float>> //relative to total known attention
    total_paid_attention: Map<User_handle, float> //relative to total known attention
    total_received_attention: Map<User_handle, float> //relative to total known attention
